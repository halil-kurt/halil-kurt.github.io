...
window.onload = function () {
    ...
    class Button {
        constructor({ x, title, img: img }) {
            this.img = img;
            this.width = img.width * 1.3 * divider;
            this.height = img.height * 1.3 * divider;
            this.title = title;
    ...
    let init = () => {
        ...
        buttons = [
            ...
            new Button({ x: screenWidth * (0.2), title: "right", img: right }),
            new Button({ x: screenWidth * (0.68), title: "sword", img: sword }),
            new Button({ x: screenWidth * (0.75), title: "throw", img: axe }),
            new Button({ x: screenWidth * (0.85), title: "jump", img: jump })
        ];
    ...
    function isInside(pointerX, pointerY) {
        ...
        let result = null;
        buttons.forEach((button) => {
            if (pointerY > button.position.y -10
                && pointerY < button.position.y + button.height + 10
